...
<p>{*mostrar_estado_proceso*}</p>',
    ...
    public function createBusquedas()
    {
        ...
        $busquedaComponente = [
            ...
            'orden' => 1,
            'url' => NULL,
            'info' => '[{"title":"Ticket","field":"{*verDocumentoTicket@iddocumento,numero*}","align":"center"},{"title":"Fecha","field":"{*fecha*}","align":"center"},{"title":"Usuario","field":"{*mostrarUsuarioTicket@dependencia*}","align":"center"},{"title":"Clasificacion por usuario","field":"{*mostrarPreClasificacionTicket@pre_clasificacion*}","align":"center"},{"title":"Clasificar","field":"{*listarClasificacionesTicket@id,iddocumento*}","align":"center"},{"title":"Descripcion","field":"{*descripcion*}","align":"center"}]',
        ...
        $busquedaComponente = [
            ...
            'orden' => 1,
            'url' => NULL,
            'info' => '[{"title":"Ticket","field":"{*verDocumentoTicket@iddocumento,numero*}","align":"center"},{"title":"Fecha","field":"{*fecha*}","align":"center"},{"title":"Usuario","field":"{*mostrarUsuarioTicket@dependencia*}","align":"center"},{"title":"Clasificaci&oacute;n","field":"{*mostrarClasificacionTicket@clasificacion*}","align":"center"},{"title":"Clasificar","field":"{*listarClasificacionesTicket@id,iddocumento*}","align":"center"},{"title":"Descripcion","field":"{*descripcion*}","align":"center"},{"title":"Acciones","field":"{*accionesTicket@iddocumento*}","align":"center"}]',
            'encabezado_componente' => NULL,
        ...
        $busquedaComponente = [
            ...
            'orden' => 1,
            'url' => NULL,
            'info' => '[{"title":"Clasificacion principal","field":"{*mostrarEnlaceSecundaria@idma_clasificacion,nombre*}","align":"center"},{"title":"Tiempo de respuesta","field":"{*cant_dias*}","align":"center"},{"title":"Estado","field":"{*estado*}","align":"center"},{"title":"Acciones","field":"{*options@idma_clasificacion,nombre_tabla*}","align":"center"}]',
            'encabezado_componente' => NULL,
            'campos_adicionales' => "a.idma_clasificacion,a.nombre,case a.estado when 1 then 'Activo' else 'inactivo' end as estado, 'ma_clasificacion' as nombre_tabla,a.cant_dias",
        ...
        $busquedaComponente = [
            ...
            'orden' => 2,
            'url' => NULL,
            'info' => '[{"title":"Nombre","field":"{*nombre*}","align":"center"},{"title":"Tiempo de respuesta","field":"{*cant_dias*}","align":"center"},{"title":"Estado","field":"{*estado*}","align":"center"},{"title":"Acciones","field":"{*options@idma_clasificacion,nombre_tabla*}","align":"center"}]',
            'encabezado_componente' => NULL,
            'campos_adicionales' => "a.idma_clasificacion,a.nombre,case a.estado when 1 then 'Activo' else 'inactivo' end as estado, 'ma_clasificacion' as nombre_tabla,a.cant_dias",
            'tablas_adicionales' => 'ma_clasificacion a',
            'ordenado_por' => 'a.nombre',
